...
```javascript
{
  ...
  rate_date: '2026-08-21',   // Central Bank of Chile's own publication date
  source: 'USD',
  target: 'CLP',
  rate: 923.23,
  rate_type: 'reference',
...
```javascript
{
  ...
  rates: [
    { "base": "USD", "quote": "CLP", "type": "reference", "value": 923.23 },
...
const series = await getHistory(
  { source: 'USD', target: 'CLP', from: '2026-01-01', to: '2026-08-21' },
  { apiKey: 'art_live_...' }
);
```
...
```javascript
{
  ...
  rates: [
    ...
    { date: '2026-08-21', rate: 923.23, rate_type: 'reference', derived: false, method: 'published' },
    // …
  ],
  disclaimer: '…'
}
