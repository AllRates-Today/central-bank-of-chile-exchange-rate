// Central Bank of Chile exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bcch';
...
/** Latest rate for one pair, e.g. getRate('USD', 'CLP', { apiKey }). */
